/// Physical dimension restriction on a way (height, width, length, weight).
...
/// - `max_length_dm`: max length in decimetres (0.1 m). E.g. 120 = 12.0 m.
...
impl DimRestriction {
    ...
    pub fn blocks_vehicle(
        ...
        (self.max_height_dm > 0 && height_dm > 0 && height_dm > self.max_height_dm)
            ...
            || (self.max_length_dm > 0 && length_dm > 0 && length_dm > self.max_length_dm)
