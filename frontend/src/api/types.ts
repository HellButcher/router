...
export interface components {
    schemas: {
        ...
        LocateRequest: {
            ...
            /**
             * @description Controls how much meta information is included in the response. Defaults to [`MetaDetail::None`].
             * @default None
             */
            with_meta?: components["schemas"]["MetaDetail"];
        };
        /**
         ...
         */
        ServiceStatus: "ok";
        SingleOrVec_for_NodeMeta: components["schemas"]["NodeMeta"] | components["schemas"]["NodeMeta"][];
        SnapMode: "Node" | "Edge";
        /**
