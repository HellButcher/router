...
export interface components {
  schemas: {
    ...
    /**
     * @description A request to snap a list of coordinates to the nearest routable node.
     *
     ...
     *
     *     Each output location corresponds to the input at the same index. If a node was found within the configured `max_radius_m`, the coordinate is replaced with that node's exact position. Otherwise the input coordinate is returned unchanged.
     *
